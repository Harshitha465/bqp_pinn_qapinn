...
class ClassicalPINN(nn.Module):
    """
    Classical Physics-Informed Neural Network (PINN) architecture.
    Baseline fully-connected architecture: 2 -> 25 -> 25 -> 25 -> 25 -> 3
    (or custom layers provided at initialization).
    """
